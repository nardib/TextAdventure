...
This command will both compile and test the code, other than creating the executable file. It also generates the javadoc documentation in `target/site/apidocs`
